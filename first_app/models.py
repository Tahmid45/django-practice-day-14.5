...
# from django.core.validators import validators_comma_separated_integer_list
...
class MyModel(models.Model):
    ...
    # comma_separated_field = models.CommaSeparatedIntegerField(validators=[comma_separated_integer_list],max_length=255)
